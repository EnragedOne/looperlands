    ...
    var Game = Class.extend({
        init: function(app) {
            ...
            this.spriteNames = ["hand", "sword", "loot", "target", "talk", "float", "sparks", "shadow16", "rat", "skeleton", "skeleton2", "spectre", "boss", "deathknight", 
                                ...
                                "enragedcoy", "enragedsalmon", "enragedshark",
                                // @nextCharacterLine@
                                "item-BOARHIDE",
                                "item-THUDKEY",
                                "item-BATWING",
        ...
        initFish: function() {
            ...
            this.fish["enragedcoy"] = this.sprites["enragedcoy"];
            this.fish["enragedsalmon"] = this.sprites["enragedsalmon"];
            this.fish["enragedshark"] = this.sprites["enragedshark"];
        },
